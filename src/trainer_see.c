...
static void SetIconSpriteData(struct Sprite *sprite)
{
...
{
    u8 spriteId = CreateSpriteAtEnd(&sSpriteTemplate_EmoteIcons, 0, 0, 0x52);

    if (spriteId != MAX_SPRITES)
    {
        struct Sprite *sprite = &gSprites[spriteId];
        // LoadObjectEventPalette(0x1100); // OBJ_EVENT_PAL_TAG_BRENDAN, uncomment this if you're using dynamic overworld palettes
        SetIconSpriteData(sprite);
        sprite->oam.paletteNum = 2; //! delete this if you're using dynamic overworld palettes
    }
