...
const u8 gText_LeagueChamp[] = _("PIT OF 100 TRIALS CHAMPION!\nCONGRATULATIONS!                   v2.0.0 Gen3");
const u8 gText_LostRunChamp[] = _("Good Progress!\nand Good Luck Next Time!         v2.0.0 Gen3");
#endif
#ifdef PIT_GEN_5_MODE
const u8 gText_LeagueChamp[] = _("PIT OF 100 TRIALS CHAMPION!\nCONGRATULATIONS!                   v2.0.0 Gen5");
const u8 gText_LostRunChamp[] = _("Good Progress!\nand Good Luck Next Time!         v2.0.0 Gen5");
#endif
#ifdef PIT_GEN_9_MODE
const u8 gText_LeagueChamp[] = _("PIT OF 100 TRIALS CHAMPION!\nCONGRATULATIONS!                   v2.0.0 Gen9");
const u8 gText_LostRunChamp[] = _("Good Progress!\nand Good Luck Next Time!         v2.0.0 Gen9");
#endif
...
const u8 gText_DepositMonDescription[] = _("Save your favorite Winning Pokémon \nin your Boxes.");
