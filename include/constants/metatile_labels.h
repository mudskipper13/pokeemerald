...
#define METATILE_Cave_FLOOR_COMPLETE                     0x347
...
// gTileset_PitArenaSnow
#define METATILE_PitArenaSnow_SNOW_WARP_ACTIVE  0x037

// gTileset_PitArenaSpiderCave
#define METATILE_PitArenaSpiderCave_SPIDER_CAVE_WARP_ACTIVE  0x021

// gTileset_PitArenaSpiderWoods
#define METATILE_PitArenaSpiderWoods_SPIDER_WOODS_WARP_ACTIVE  0x004

// gTileset_PitArenaUnderwater
#define METATILE_PitArenaUnderwater_UNDERWATER_WARP_ACTIVE  0x016

// gTileset_PitArenaWhiteBark
#define METATILE_PitArenaWhiteBark_WHITEBARK_WARP_ACTIVE  0x019

// gTileset_PitWaterTheme
#define METATILE_PitWaterTheme_WATER_WARP_ACTIVE  0x011
